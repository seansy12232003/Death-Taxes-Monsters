...
@export var zoom_out_factor: Vector2 = Vector2(1.5, 1.5)  # How much the camera should zoom out
@export var pan_duration: float = 4.0  # Duration of the pan
@export var return_duration: float = 2.0  # Duration to return to the original position
